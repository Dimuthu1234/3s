...
@section('pageicon', 'fa fa-tachometer')
@section('pagenameheader', 'Dashboard')
@section('pagenametitle', '3S Dashboard')

{{-- breadcrumbs goes here --}}
@section('bc1', 'You are here')
@section('bc2', '3S')
@section('bc3', 'Dashboard')
                            ...
                            <tr>
                                ...
                                <td class="progress-cell">
                                    <div class="progress-info">
                                        <div class="percent"><span class="animate-number"
                                                                   data-value="50"
                                                                   data-animation-duration="1500">0</span>%
                                        </div>
                                    </div>
                                    <div class="progress progress-little">
                                        <div
                                            class="progress-bar progress-bar-transparent-white animate-progress-bar"
                                            data-percentage="50%"></div>
                                    </div>
                                </td>
                                <td class="text-right"><span
                                        id="projectbar1">87,85,42,90,70,55,82,68</span></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                ...
                                <td class="text-right"><span
                                        id="projectbar2">87,99,52,93,42,86,51,93</span></td>
                            </tr>
                            <tr>
                                <td>3</td>
                                ...
                                <td class="text-right"><span
                                        id="projectbar3">74,77,82,91,69,63,46,42</span></td>
                            </tr>
                            <tr>
                                <td>4</td>
                                ...
                                <td class="text-right"><span
                                        id="projectbar4">52,45,76,74,77,57,65,86</span></td>
                            </tr>
                            <tr>
                                <td>5</td>
                                ...
                                <td class="text-right"><span
                                        id="projectbar5">53,70,47,96,62,49,69,55</span></td>
                            </tr>
                            <tr>
                                <td>6</td>
                                ...
                                <td class="text-right"><span
                                        id="projectbar6">69,80,85,96,67,58,75,82</span></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <section class="tile color transparent-black textured">
                ...
                <div class="tile-widget">
                    ...
                    <div class="progress-list with-heading">
                        <div class="details">
                            <div class="title"><h2><i class="fa fa-hdd-o"></i> <span
                                        class="animate-number" data-value="394"
                                        data-animation-duration="1600">0</span> GB</h2></div>
                        </div>
                        <div class="status pull-right bg-transparent-black-1">
                            <span class="animate-number" data-value="42" data-animation-duration="1500">0</span>%
                        </div>
                    ...
                    <p class="description"><strong>394GB</strong> used of <strong class="white-text">2,048GB</strong>
                        on File Server</p>
                </div>
                <!-- /tile widget -->
            ...
            <section class="tile color transparent-black">
                ...
                <div class="tile-body">
                    ...
                    <ul class="inline text-center chart-legend">
                        <li><span class="badge badge-outline" style="border-color: #00a3d8"></span>
                            Chrome
                            <small>25%</small>
                            ,
                        </li>
                        <li><span class="badge badge-outline" style="border-color: #1693A5"></span>
                            Other
                            <small>25%</small>
                            ,
                        </li>
                        <li><span class="badge badge-outline" style="border-color: #2fbbe8"></span>
                            Safari
                            <small>20%</small>
                            ,
                        </li>
                        <li><span class="badge badge-outline" style="border-color: #72cae7"></span>
                            Firefox
                            <small>15%</small>
                            ,
                        </li>
                        <li><span class="badge badge-outline" style="border-color: #ffc100"></span>
                            Internet Explorer
                            <small>10%</small>
                            ,
                        </li>
                        <li><span class="badge badge-outline" style="border-color: #d9544f"></span>
                            Opera
                            <small>5%</small>
                        </li>
                    </ul>
                ...
                <div class="tile-body tab-content nopadding rounded-bottom-corners">
                    ...
                    <ul id="messages-tab" class="tab-pane fade">
                        <li>
                            ...
                            <span
                                class="subject">received new message from <strong>Peter Kay</strong></span>
                            <span class="time"><i class="fa fa-clock-o"></i> 15 minutes ago</span>
                        </li>
                        <li>
                            <img src="assets/images/profile-photo.jpg" class="w35" alt>
                        ...
                        <li>
                            ...
                            <span class="user font-slab"><strong>You</strong></span>
                            <span
                                class="subject">received new message from <strong>Ing. Imrich Kamarel</strong></span>
                            <span class="time"><i class="fa fa-clock-o"></i> 35 minutes ago</span>
                        </li>
                        <li>
                            <img src="assets/images/profile-photo.jpg" class="w35" alt>
                            <span class="user font-slab"><strong>You</strong></span>
                            <span
                                class="subject">received new message from <strong>Arnold Arnold</strong></span>
                        ...
                        <li>
                            ...
                            <span class="user font-slab"><strong>You</strong></span>
                            <span
                                class="subject">received new message from <strong>George McCain</strong></span>
                            <span class="time"><i class="fa fa-clock-o"></i> 1 hour ago</span>
                        </li>
                        <li>
                            <img src="assets/images/profile-photo.jpg" class="w35" alt>
                ...
                <div class="tile-widget color transparent-black rounded-top-corners">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group no-bottom-margin">
                            <label for="subject"
                                   class="col-sm-2 control-label font-slab">Subject</label>
                            <div class="col-sm-10">
