...
<script src="{{ url('assets/js/vendor/bootstrap/bootstrap-dropdown-multilevel.js') }}"></script>
<script type="text/javascript" src="{{ url('assets/js/vendor/mmenu/js/jquery.mmenu.min.js') }}"></script>
<script type="text/javascript" src="{{ url('assets/js/vendor/sparkline/jquery.sparkline.min.js') }}"></script>
<script type="text/javascript" src="{{ url('assets/js/vendor/nicescroll/jquery.nicescroll.min.js') }}"></script>
<script type="text/javascript" src="{{ url('assets/js/vendor/animate-numbers/jquery.animateNumbers.js') }}"></script>
<script type="text/javascript" src="{{ url('assets/js/vendor/videobackground/jquery.videobackground.js') }}"></script>
<script type="text/javascript" src="{{ url('assets/js/vendor/blockui/jquery.blockUI.js') }}"></script>

<script src="{{ url('assets/js/vendor/flot/jquery.flot.min.js') }}"></script>
<script src="{{ url('assets/js/vendor/flot/jquery.flot.time.min.js') }}"></script>
<script src="{{ url('assets/js/vendor/flot/jquery.flot.selection.min.js') }}"></script>
<script src="{{ url('assets/js/vendor/flot/jquery.flot.animator.min.js') }}"></script>
<script src="{{ url('assets/js/vendor/flot/jquery.flot.orderBars.js') }}"></script>
<script src="{{ url('assets/js/vendor/easypiechart/jquery.easypiechart.min.js') }}"></script>

<script src="{{ url('assets/js/vendor/rickshaw/raphael-min.js') }}"></script>
<script src="{{ url('assets/js/vendor/rickshaw/d3.v2.js') }}"></script>
...
<script src="{{ url('assets/js/vendor/tabdrop/bootstrap-tabdrop.min.js') }}"></script>
...
<script src="{{ url('assets/js/minimal.min.js') }}"></script>
